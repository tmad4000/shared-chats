  ...
  return (
    <main style={{ maxWidth: 720, margin: "0 auto", padding: "60px 24px 40px" }}>
      ...
      <footer style={{ marginTop: 40, color: "var(--text-tertiary)", fontSize: 12, textAlign: "center" }}>
        v0.0.5 · <a href="https://github.com/tmad4000/shared-chats" style={{ color: "var(--text-tertiary)" }}>github.com/tmad4000/shared-chats</a> · <a href="/api/health" style={{ color: "var(--text-tertiary)" }}>health</a>
      </footer>
    </main>
  );
}
